...
export const GAS_URL = 'https://script.google.com/macros/s/AKfycbwCVaPuN718YzNjrq7vZ-kwkDbujAR50x8GDfbSGgwSqCXuJpIH2MYoNTF9edRBMAtr/exec';
...
// Workflow Tes Bacaan (per sesi)
export const getTestWorkflowStatus = (payload) => api('getTestWorkflowStatus', payload);

// Rapot PDF
export const saveRapotPdf = (d) => api('saveRapotPdf', d);
